...
exports.show=function (request,response)
{
    ...
    if(request.query.error!=undefined){
        response.render('addNewVehicleAdmin',{title:title, CompanyID:CompanyID,error:request.query.error});
    }
    else{
      response.render('addNewVehicleAdmin',{title:title, CompanyID:CompanyID});
    }
}
...
exports.handle_Input=function (request,response)
{
    ...
    poolH.getConnection(function(err,connection){
                        ...
                        connection.query(checkVehicle,function(err,rows){
                                         ...
                                         response.render('addNewVehicleAdmin',{title:title, CompanyID:CompanyID,errorMessage:errorM});
                                         }
                                         else{
                                         ...
                                         connection.query(findLargestVehicleID,function(err,rows){//First, found the largest CompanyID;
                                                          ...
                                                          connection.query(insert, VehicleInput ,function(err,rows){
                                                                           ...
                                                                           jumpToChoose(request,response,VIN,CompanyID);
                                                                           }
                                                                           else{
                                                          ...
                                                          response.render('addNewVehicleAdmin',{ title:title ,CompanyID:CompanyID,errorMessage:'Failed to find max VehicleID'});
                                                          }
...
function jumpToChoose(req,res,VIN1,CompanyID){
