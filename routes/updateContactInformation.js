    ...
    var ContactID = req.body.ContactID;
        ...
        poolH.getConnection(function(err,connection){
                            ...
                            connection.query(queryClause, newValue,function(err,rows){
                                             ...
                                             res.redirect('http://localhost:9000/updateContactInformation/'+username+'?Success=MNBHUYHHHNNNJK1231&tag1='+tag1);
        ...
        poolH.getConnection(function(err,connection){
                            ...
                            connection.query(queryClause, newValue,function(err,rows){
                                             if(!err)
                                             {
                                             res.redirect('http://localhost:9000/updateContactInformation/'+username+'?Success=MNBHUYHHHNNNJK1232&tag2='+tag2);
                                             }
                                             else
                                             {
